...
use crate::atoms::{Co64Atom, MoofAtom, MoovAtom, MvexAtom, StcoAtom, TrafAtom, stsz::SampleSize};
...
impl StreamSegment for MoofSegment {
    ...
    fn sample_data(
        ...
        let default_size = traf
            .tfhd
            .default_sample_size
            .unwrap_or(self.mvex.trexs[track_num].default_sample_size);
