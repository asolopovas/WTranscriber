    ...
    <div class="px-xl pt-xl pb-md border-b border-outline-variant/40 flex flex-col gap-md">
      <div class="flex items-end justify-between gap-margin">
        <div>
          ...
          <p class="text-bodyMedium text-on-surface-variant mt-unit">Persistent runtime log — engine errors, model installs, transcribe runs.</p>
        </div>
        <div class="flex items-center gap-xs shrink-0">
          <label class="flex items-center gap-unit text-bodyMedium text-on-surface-variant cursor-pointer select-none">
